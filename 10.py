...
#===========Hiburan============#
                        ...
                        elif cmd == "buron" or text.lower() == 'bc':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                    ki.sendMessage(msg.to,"ติดดำอยู๋..")
                                    kk.sendMessage(msg.to,"ติดดำอยู๋..")
                                    kc.sendMessage(msg.to,"ติดดำอยู๋..")
                                    kb.sendMessage(msg.to,"ติดดำอยู๋..")
                                    kd.sendMessage(msg.to,"ติดดำอยู๋..")
                                    ke.sendMessage(msg.to,"ติดดำอยู๋..")
                                    kf.sendMessage(msg.to,"ติดดำอยู๋..")
                                    kg.sendMessage(msg.to,"ติดดำอยู๋..")
                              else:
                                    ma = ""
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              ki.sendMessage(msg.to,"ล้างดำ..ok" +mc)
                              kk.sendMessage(msg.to,"ล้างดำ..ok" +mc)
                              kc.sendMessage(msg.to,"ล้างดำ..ok" +mc)
                              kb.sendMessage(msg.to,"ล้างดำ..ok" +mc)
                              kd.sendMessage(msg.to,"ล้างดำ..ok" +mc)
                              ke.sendMessage(msg.to,"ล้างดำ..ok" +mc)
                              kf.sendMessage(msg.to,"ล้างดำ..ok" +mc)
                              kg.sendMessage(msg.to,"ล้างดำ..ok" +mc)
